...
class App(tk.Tk):
    def __init__(self):
        ...
        self.products_catalog = [Product("Хлеб", 60), Product("Молоко", 70), Product("Масло", 220), Product("Кефир", 60), Product("Сметана", 90)]
    ...
    def setup_clients_tab(self):
        ...
        ttk.Label(frm, text="Телефон (+1234567890):").grid(row=2, column=0)
